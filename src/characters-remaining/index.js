/**
* Used for keeping track of the number of characters left in a textarea
...
if (!window.customElements.get(CharactersRemaining.TAG_NAME)) {
  window.customElements.define(CharactersRemaining.TAG_NAME, CharactersRemaining)
}
